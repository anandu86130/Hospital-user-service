...
var file_pb_user_proto_rawDesc = []byte{
	...
	0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x61, 0x67, 0x65, 0x12, 0x16, 0x0a, 0x06,
	...
	0x09, 0x52, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x32, 0x98, 0x02, 0x0a, 0x04, 0x75,
	...
	0x74, 0x61, 0x69, 0x6c, 0x73, 0x42, 0x04, 0x5a, 0x02, 0x2e, 0x2f, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_pb_user_proto_depIdxs = []int32{
	...
	2, // 1: user.user.VerifyOTP:input_type -> user.VerifyOTPRequest
	4, // 2: user.user.Login:input_type -> user.LoginRequest
	6, // 3: user.user.IndUserDetails:input_type -> user.idreq
	7, // 4: user.user.UpdateUserDetails:input_type -> user.UserDetails
	1, // 5: user.user.Signup:output_type -> user.SignupResponse
	3, // 6: user.user.VerifyOTP:output_type -> user.VerifyOTPResponse
	5, // 7: user.user.Login:output_type -> user.LoginResponse
	7, // 8: user.user.IndUserDetails:output_type -> user.UserDetails
	7, // 9: user.user.UpdateUserDetails:output_type -> user.UserDetails
